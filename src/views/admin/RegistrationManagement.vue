        ...
        <table v-if="list.length > 0" class="w-full text-sm">
          <thead>
            <tr class="border-b border-gray-100 bg-slate-50/50 text-left">
              ...
              <th class="px-5 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider">负责人姓名</th>
      ...
      <div class="bg-white rounded-2xl shadow-2xl max-w-lg w-full mx-4 overflow-hidden">
        ...
        <div class="p-6 space-y-4">
          <div class="grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <span class="text-xs text-slate-400 uppercase tracking-wider block mb-1">负责人真实姓名</span>
