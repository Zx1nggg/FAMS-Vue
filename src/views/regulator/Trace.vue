<template>
  <div class="min-h-screen bg-slate-100 p-4 md:p-6 font-sans">
    <div class="max-w-6xl mx-auto space-y-5">
      ...
      <div v-if="trace" class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <section class="lg:col-span-2 bg-white border border-slate-200 rounded-lg shadow-sm p-5">
...
import { ref } from 'vue'
import { quickTrace } from '@/api/regulator'
import type { TraceChain } from '@/types/regulator'
